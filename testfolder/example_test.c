 ...
 */
  __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_v_iterations); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_v_energysum = f(((float *)__pyx_v_np_in_phi->data), ((float *)__pyx_v_out_phi->data), __pyx_t_8);
 ...
 */
  ...
  __pyx_t_6 = PyFloat_FromDouble(__pyx_v_energysum); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 0, ((PyObject *)__pyx_v_out_phi));
